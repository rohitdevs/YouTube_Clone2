...
window.addEventListener("load", () => {
  ...
  all.addEventListener("click", () => {
    window.location.href = "https://rohitdevs.github.io/YouTube_Clone2/index.html";
  });
  try {
...
function navigateToChannelPage(authorImage, authorName, channelId) {
  document.cookie = `authorImage=${authorImage}; path=https://rohitdevs.github.io/YouTube_Clone2/channelDetails.html`;
  document.cookie = `authorName=${authorName}; path=https://rohitdevs.github.io/YouTube_Clone2/channelDetails.html`;
  document.cookie = `channelId=${channelId}; path=https://rohitdevs.github.io/YouTube_Clone2/channelDetails.html`;

  window.location.href = `https://rohitdevs.github.io/YouTube_Clone2/channelDetails.html`;
}
