...
function navigateToVideoDetails(
  ...
  document.cookie = `id=${videoId}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `videoTitle=${videoTitle}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `viewsCount=${viewCount}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `uploadDate=${uploadDate}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `likesCount=${likesCount}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `channelLogo=${channelLogo}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `channelName=${channelName}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
  document.cookie = `subscribersCount=${subscribersCount}; path=https://rohitdevs.github.io/YouTube_Clone2/video-details.html`;
